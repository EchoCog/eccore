...
describe('DeepTreeEchoBot', () => {
  ...
  describe('processMessage', () => {
    it('should process regular messages and return a response', async () => {
      ...
      // processMessage now returns void, so we just verify it doesn't throw
    })
    ...
    it('should return an empty string if bot is disabled', async () => {
      ...
      // processMessage now returns void, bot disabled state is handled internally
    })
    ...
    it('should handle command messages', async () => {
      ...
      // processMessage now returns void, commands are handled internally
    })
  ...
  describe('updateOptions', () => {
    it('should update options', () => {
      ...
      return bot.processMessage(1, 100, 123, message as any)
        .then(response => {
